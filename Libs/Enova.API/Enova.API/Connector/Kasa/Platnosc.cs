...
namespace Enova.API.Connector.Kasa
{
    internal class Platnosc : Business.GuidedRow, API.Kasa.Platnosc
    {
        ...
        {
            get { return FromEnova<API.Kasa.EwidencjaSP>("EwidencjaSP"); }
            set { ToEnova("EwidencjaSP", value); }
        }
        ...
        public API.Core.KierunekPlatnosci Kierunek
        {
            get
            {
                ...
                return FromEnova<API.Core.KierunekPlatnosci>("Kierunek");
            }
        }
        ...
        {
            get { return FromEnova<API.Kasa.SposobZaplaty>("SpozobZaplaty"); }
            set { ToEnova("SposobZaplaty", value); }
        }
